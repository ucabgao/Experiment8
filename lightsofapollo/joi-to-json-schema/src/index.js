...
var TYPES = {
    ...
    array: function (schema, joi) {
        ...
        if (joi._inner && joi._inner.inclusions && joi._inner.inclusions.length > 0) {
            ...
            joi._inner.inclusions.forEach(function (i) {
...
function convert(joi) {
    assert_1["default"]('object' === typeof joi && true === joi.isJoi, 'requires a joi schema object');
    assert_1["default"](joi._type, 'has type');
    assert_1["default"](TYPES[joi._type], "cannot convert " + joi._type);
